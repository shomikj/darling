...
MAX_LEN   = 2048                 # token budget for CLS + s1 + SEP + s2 + SEP
...
@functools.cache
def get_tokenizer():
    #tokenizer = AutoTokenizer.from_pretrained("/checkpoint/ram/tianjian/similarity-classifier-f168-hf/")
...
def test_partition():
    ...
    solution_str = [
        ...
        "Why do coders avoid bright screens?Because bugs are drawn to the light!",
